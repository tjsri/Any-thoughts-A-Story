...
let saveButton, flyButton, homeButton; // Added homeButton
...
function windowResized() {
  ...
  // Reposition home button on resize to keep it in the corner
...
function setupUI() {
  ...
  // --- ADDED HOME BUTTON ---
  homeButton = createButton('READ A STORY');
  homeButton.position(windowWidth - 100, 25); // Top-right corner
  buttonStyle(homeButton);
  homeButton.mousePressed(() => {
    window.location.href = "https://tjsri.github.io/A-Story/";
  });
